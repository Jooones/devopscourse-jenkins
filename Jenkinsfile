node() {
    stage('Build') {
        ...
        sh './gradlew build -Porg.gradle.java.home=/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.151-1.b12.el7_4.x86_64'
    }
    stage('Test') {
        sh './gradlew test -Porg.gradle.java.home=/usr/lib/jvm/java-1.8.0-openjdk-1.8.0.151-1.b12.el7_4.x86_64'
    }
}